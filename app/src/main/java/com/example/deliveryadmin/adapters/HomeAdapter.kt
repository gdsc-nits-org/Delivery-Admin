...
class HomeAdapter(val onItemClicked: (String)->Unit, private val context : Context, private val orderID: ArrayList<String>): RecyclerView.Adapter<HomeAdapter.OrdersViewHolder>(){
